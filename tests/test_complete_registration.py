...
def test_registration(driver):
    ...
    driver.find_element(*RegistrationPageLocators.email_field).send_keys('romantest2008@yandex.ru')
    ...
    driver.find_element(*LoginPageLocators.email_field).send_keys('romantest2008@yandex.ru')
    ...
    assert current_email.get_attribute('value') == 'romantest2008@yandex.ru'